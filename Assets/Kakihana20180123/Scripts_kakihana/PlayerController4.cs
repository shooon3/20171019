...
public class PlayerController4 : MonoBehaviour {
    ...
    [SerializeField]
    private MouseManager mousemanager; // マウス移動のデータ
    [SerializeField]
    private Curve headCurve; // カメラの上下移動のデータ
    [SerializeField]
    private LerpController lerpcontroller; // カメラの回転部分のデータ

    [SerializeField]
    public int energy = 100; // スタンガン発射に必要なエネルギー
    [SerializeField]
    public int maxEnergy = 100;
    [SerializeField]
    private float bulletTimeInterval = 0.0f; // スタンガン発射間隔
    [SerializeField]
    private float punchTimeInterval = 0.0f; // 素手攻撃の間隔

    [SerializeField]
    private Camera playerCam; // カメラオブジェクトを格納
